...
INSTALLER="${TEMPORARY_FILES}/parallel_studio_xe_2016_update3_online.sh"
INSTALLER_URL="http://registrationcenter-download.intel.com/akdlm/irc_nas/9061/parallel_studio_xe_2016_update3_online.sh"
