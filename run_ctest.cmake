...
if(CC_NAME STREQUAL "msvc" OR CC_NAME STREQUAL "clang")
    ...
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
    if(CC_NAME STREQUAL "msvc")
        set(CC_ANALYSE_FLAGS "/analyze")
    elseif(CC_NAME STREQUAL "clang")
        set(CC_ANALYSE_FLAGS "--analyze")
    endif()
    if(DEFINED ENV{CMAKE_TOOLCHAIN_FILE})
        ctest_configure(OPTIONS -DCI_FLAGS=${CC_ANALYSE_FLAGS} -DCMAKE_TOOLCHAIN_FILE=$ENV{CMAKE_TOOLCHAIN_FILE})
    else()
        ctest_configure(OPTIONS -DCI_FLAGS=${CC_ANALYSE_FLAGS})
    endif()
    ctest_build()
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "MemorySanitizer")
    ...
    ctest_update()
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
    set(CC_MSAN_FLAGS "-fsanitize=memory")
    if(DEFINED ENV{CMAKE_TOOLCHAIN_FILE})
