...
if(CTEST_MEMORYCHECK_COMMAND)
    ...
    if(CC_NAME STREQUAL "mingw" AND CC_ARCH STREQUAL "x86_64")
        ctest_configure(OPTIONS "-DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-x86_64-w64-mingw32.cmake -DCI_FLAGS=-fno-omit-frame-pointer")
    elseif(CC_NAME STREQUAL "mingw" AND CC_ARCH STREQUAL "x86")
        ctest_configure(OPTIONS "-DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-i686-w64-mingw32.cmake -DCI_FLAGS=-fno-omit-frame-pointer")
    else()
