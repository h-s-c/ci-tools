    ...
    if(DEFINED ENV{CC})
        ...
        if($ENV{CC} STREQUAL "x86_64-w64-mingw32-gcc" OR $ENV{CC} STREQUAL "i686-w64-mingw32-gcc")
            ...
            if($ENV{CC} STREQUAL "x86_64-w64-mingw32-gcc" )
                set(CC_ARCH "x86_64")
                list(APPEND CONFIGURE_OPTIONS "-DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-x86_64-w64-mingw32.cmake")
            elseif($ENV{CC} STREQUAL "i686-w64-mingw32-gcc")
                set(CC_ARCH "x86")
                list(APPEND CONFIGURE_OPTIONS "-DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-i686-w64-mingw32.cmake")
            endif()
...
list(APPEND CONFIGURE_OPTIONS "-DCI_FLAGS=-fno-omit-frame-pointer")
...
if(CTEST_MEMORYCHECK_TYPE STREQUAL "AddressSanitizer")
    ...
    ctest_update()
    ctest_read_custom_files(${CTEST_SOURCE_DIRECTORY})
    ctest_configure(OPTIONS "-DCI_FLAGS=${CC_ASAN_FLAGS} -fsanitize=address -fno-omit-frame-pointer")
    ctest_build()
    ctest_test()
    ctest_memcheck()
    ctest_submit(PARTS Start Update Configure Build Test MemCheck Upload Submit)
