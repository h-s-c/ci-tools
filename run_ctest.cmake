    ...
    if(DEFINED ENV{CC})
        ...
        if($ENV{CC} STREQUAL "x86_64-w64-mingw32-gcc" OR $ENV{CC} STREQUAL "i686-w64-mingw32-gcc")
            ...
            if($ENV{CC} STREQUAL "x86_64-w64-mingw32-gcc" )
                set(CC_ARCH "x86_64")
                list(APPEND CONFIGURE_OPTIONS "OPTIONS -DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-x86_64-w64-mingw32.cmake")
            elseif($ENV{CC} STREQUAL "i686-w64-mingw32-gcc")
                set(CC_ARCH "x86")
                list(APPEND CONFIGURE_OPTIONS "OPTIONS -DCMAKE_TOOLCHAIN_FILE=ci-tools/toolchain/toolchain-i686-w64-mingw32.cmake")
            endif()
...
ctest_configure(${CONFIGURE_OPTIONS})
ctest_build()
ctest_test()
