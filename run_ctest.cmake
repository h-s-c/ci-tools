...
if(UNIX)
    ...
    exec_program($ENV{CC} ARGS --version OUTPUT_VARIABLE CC_VERSION)
    string(REGEX REPLACE ".*Optimizing Compiler Version ([0-9]+\\.[0-9]+).*" "\\1" CC_VERSION ${CC_VERSION})
    string(SUBSTRING "${CC_VERSION}" 0 2 CC_VERSION)
    if(CC_VERSION STREQUAL "19")
        string(SUBSTRING "${CC_VERSION}" 0 5 CC_VERSION)
        if(CC_VERSION STREQUAL "19.10")
            set(CC_VERSION "2017")
        else()
            set(CC_VERSION "2015")
        endif()
    elseif(CC_VERSION STREQUAL "18")
        set(CC_VERSION "2013")
    elseif(CC_VERSION STREQUAL "17")
        set(CC_VERSION "2012")
    elseif(CC_VERSION STREQUAL "16")
        set(CC_VERSION "2010")
    elseif(CC_VERSION STREQUAL "15")
        set(CC_VERSION "2008")
    elseif(CC_VERSION STREQUAL "14")
        set(CC_VERSION "2005")
    endif()
endif()
